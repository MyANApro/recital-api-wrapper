...
/**
 * WorkflowByUUIDResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class WorkflowByUUIDResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'WorkflowByUUIDResponse';
    ...
    */
     ...
     * Sets draft_id
     *
     * @param int|null $draft_id draft_id
     *
     * @return $this
     */
    public function setDraftId(?int $draft_id): static
    {
        if (is_null($draft_id)) {
