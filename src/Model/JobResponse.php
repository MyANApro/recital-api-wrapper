...
class JobResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'JobResponse';
    ...
    */
     ...
     * Sets workflow_name
     *
     * @param string|null $workflow_name workflow_name
     *
     * @return $this
     */
     ...
     *
     * @param string|null $custom_metadata custom_metadata
     *
     * @return $this
     */
    public function setCustomMetadata(?string $custom_metadata): static
    {
